...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-lg-top stiky-offset">
        ...
        <div class="sideprofile">
            ...
            if (!empty($fetch['o_photo'])) {
                // Display the profile picture from the database
                echo '<img class="nav-link dropdown-toggle" src="Photos/' . $fetch['o_photo'] . '" height="50px" width="50px" style="border-radius:50px;border:2px solid #8000002e;cursor:pointer;  margin-right:30px;" class="user-pic" onclick="toggleMenu()">';
            } else {
            ...
            <div class="sub-menu-wrap" id="subMenu">
                <div class="sub-menu">
                    <div class="user-info">
                        ...
                        if (!empty($fetch['o_photo'])) {
                            // Display the profile picture from the database
                            echo '<img width="40px" src="Photos/' . $fetch['u_photo'] . '" style="border-radius: 50%;" class="user-pic">';
                        } else {
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <h3 id="displayedname" style="<?php echo ($fetch['u_name'] !== null && $fetch['u_name'] !== '') ? '' : 'font-size: inherit; ' ?>">
                            <?php
                            if ($fetch['o_name'] !== null && $fetch['o_name'] !== '') {
                                echo $fetch['o_name'];
                            } else {
                                        ...
                                        <div class="article-wrapper">
                                            <div class="profile-picture-container">
                                                <figure class="profile-picture">
                                                    ...
                                                    if (!empty($login_row['u_photo'])) {
                                                        // Display the profile picture from the database
                                                        echo '<img src="Photos/' . $fetch['o_photo'] . '" alt="Profile Picture" />';
                                                    } else {
                                                        // Display the default profile picture
                                            ...
                                            <div class="article-body">
                                                <div class="article-content">
                                                    <h2 style="text-align:center;">Hello<br> <span id="displayedName"> <?= $fetch['o_name']; ?></span></h2>
