        ...
        <div class="sideprofile">
            ...
            <div class="sub-menu-wrap" id="subMenu">
                <div class="sub-menu">
                    ...
                    <a href="owner-logout.php" class="sub-menu-link">
            ...
            <div class="col-md-2 bg-white" id="side-nav">
                <div href="#submenu1" data-bs-toggle="collapse" class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu" style="transition: 0.5s;">
                        ...
                        <li>
                            <a href="booking_request.php" class="nav-link px-0 align-middle">
                    ...
                    <div class="main__cards">
                        <div class="card">
                            ...
                            <div class="card_inner">
                                <span class="font-bold text-title" style="font-weight: 700; font-size: 5vh;">
                                    583
                                </span>
                                <i class="fa fa-thin fa-building-wheat fa-beat-fade fa-2xl" style="color: #000000;"></i>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card_inner">
                                ...
                                <i class="fa fa-thin fa-magnifying-glass-chart fa-beat-fade fa-2xl" style="color: #000000;"></i>
                            </div>
                        </div>
                        <div class="card">
                            <h6>Rating</h6>
                            ...
                            <div class="card_inner">
                                ...
                                <i class="fa fa-regular fa-star-half-stroke fa-beat-fade fa-2xl" style="color: #000000;"></i>
                            </div>
                        </div>

                    </div>
                    <div id="myPlot" style="width:100%;max-width:700px;margin-top: 60px;"></div>

                    <script>
                        const xArray = [55, 49, 44, 24, 15];
                        const yArray = ["June ", "July ", "August ", "September ", "October "];
